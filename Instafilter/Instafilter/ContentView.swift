...
//  Instafilter
//
//  Created by Roberto Gutierrez on 19/11/20.
...
struct ContentView: View {
    ...
    @State var currentFilterTitle = "Sepia Tone"
    ...
    var body: some View {
        ...
        return NavigationView {
            VStack {
                ...
                HStack {
                    Button("Change filter: \(currentFilterTitle)") {
        ...
        .navigationBarTitle("Instafilter")
            ...
            .actionSheet(isPresented: $showingFilterSheet) {
                ActionSheet(title: Text("Select a filter"), buttons: [
                    .default(Text("Crystallize")) {
                        ...
                        self.currentFilterTitle = "Crystallize"
                    },
                    .default(Text("Edges")) {
            ...
            .alert(isPresented: $isErrorShowing) {
                Alert(title: Text("There's no image selected"), message: Text("Please select an image to edit before saving"), dismissButton: .default(Text("Ok")))
            }
